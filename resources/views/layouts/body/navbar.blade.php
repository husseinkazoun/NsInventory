        ...
        <div class="navbar">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item {{ request()->is('clothing*') ? 'active' : null }}">
                        <a class="nav-link" href="{{ route('clothing.index') }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                    <path d="M15 4l6 3l-3 5l-3-2v10h-6v-10l-3 2l-3-5l6-3a3 3 0 0 0 6 0"/>
                                </svg>
                            </span>
                            <span class="nav-link-title">{{ __('Clothing Inventory') }}</span>
                        </a>
                    </li>
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item" href="{{ route('lab-assets.dashboard') }}">
                                    ...
                                    <a class="dropdown-item" href="{{ route('lab-assets.index') }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                            <path d="M9 11h6l3 7h-12l3 -7z"/>
                                            <path d="M9 11v-5a3 3 0 0 1 6 0v5"/>
                                        </svg>
                                        {{ __('All Assets') }}
                                    </a>
                                    <a class="dropdown-item" href="{{ route('lab-assets.scan') }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                    ...
                                    <a class="dropdown-item" href="{{ route('lab-assets.create') }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                    ...
                    {{-- Mobile-only logout: the avatar dropdown covers desktop; this makes
                         "Log out" easy to find inside the collapsed hamburger menu on phones. --}}
                    <li class="nav-item d-md-none">
                        <form action="{{ route('logout') }}" method="post">
                            ...
                            <button type="submit" class="nav-link btn btn-link text-start w-100 border-0">
                                ...
                                <span class="nav-link-title">{{ __('Log out') }}</span>
                            </button>
                        </form>
                    </li>
